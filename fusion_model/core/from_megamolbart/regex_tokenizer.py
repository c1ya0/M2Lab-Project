...
# https://raw.githubusercontent.com/NVIDIA/NeMo/6b3d0fe2b5fc2c3b1f83a465d1ca55a530c32e30/nemo/collections/common/tokenizers/regex_tokenizer.py
...
class RegExTokenizer(TokenizerSpec):
    ...
    def __init__(
        ...
        self.regex_file = os.path.join(base, "megamolbart.model")
        self.vocab_file = os.path.join(base, "megamolbart.vocab")
        # self.regex_file = '/workspace/nemo_chem/models/vocab/megamolbart.model'
        # self.vocab_file = '/workspace/nemo_chem/models/vocab/megamolbart.vocab'
